...
screen = pygame.display.set_mode(WINDOW_SIZE,0,0) # initiate screen
 
player_image = pygame.image.load('player1.png') # just make your own image :)
...
while True: # game loop
    screen.fill((0,0,0)) # clear screen by filling it with blue
